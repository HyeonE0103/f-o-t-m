...
export const spinnerStyle = recipe({
  base: {
    ...
    //borederTop과 borderRight가 색깔이 있어서 빙글빙글 그려줌
    //borderRadius가 들어가서 원이 된 사각형에 반형만 색깔을 넣어 계속 돌아가도록 하는 것
