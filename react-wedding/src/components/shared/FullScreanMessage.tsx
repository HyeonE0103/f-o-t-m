...
import styles from './FullScreanMessage.module.scss'
import classNames from 'classnames/bind'

const cx = classNames.bind(styles)

interface FullScreanMessageProps {
  type: 'loading' | 'error'
}

const FullScreanMessage = ({ type }: FullScreanMessageProps) => {
  return (
    <div className={cx('container')}>
      {type === 'loading' ? (
        <Heart className={cx('ico-heart')} />
      ) : (
        <>
          <Error />
...
export default FullScreanMessage
